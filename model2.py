...
print('------------------------------------------------------')
print('Please find all of the information about your chosen stock from the following sources: \nYahoo Finance, MarketWatch, Morningstar, etc.')
...
dy = dividend_yield / 100  # Convert dividend yield to decimal
...
tax_rate = float(input(f'Please enter the Corporate Tax rate that {company} pays(%): '))  # Example tax rate
